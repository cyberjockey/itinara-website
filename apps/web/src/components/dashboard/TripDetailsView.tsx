...
import { ChevronDown, FileText, Download, MapPin, Phone, Globe, Clock, Info, Instagram, Facebook, Twitter, Youtube, CheckCircle2, Video, Eye } from "lucide-react";
...
function SmartText({ text, className = "" }: { text: string; className?: string }) {
    ...
    // Handle "Visitor Tips" or similar lists embedded with checkmarks
    ...
    // Standard Text Formatting (Bold, Newlines)
