...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-warm-white flex">
            ...
            {/* Mobile Header */}
            <div className="md:hidden fixed top-0 left-0 right-0 z-40 bg-white border-b border-stone-gray/10 px-4 py-3 flex items-center justify-between print:hidden">
                <button
            ...
            {/* Sidebar */}
            <aside className={`
                fixed inset-y-0 left-0 z-50 w-[85vw] md:w-64 bg-white border-r border-stone-gray/10 flex flex-col transition-transform duration-300 ease-out shadow-2xl md:shadow-none will-change-transform transform-gpu print:hidden
            ...
            {/* Main Content */}
            <main className="flex-1 md:ml-64 p-4 md:p-8 pt-20 md:pt-8 min-h-screen bg-warm-white relative w-full print:ml-0 print:p-0 print:pt-0">
                {children}
            </main>
        </div>
    );
